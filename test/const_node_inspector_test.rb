...
module Packwerk
  class ConstNodeInspectorTest < ActiveSupport::TestCase
    ...
    test "#constant_name_from_node should gracefully return nil for dynamically namespaced constants" do
      ...
      parent = Private::NodeHelpers.each_child(grandparent).entries[1] # setup do self.class::HEADERS end
      node = Private::NodeHelpers.each_child(parent).entries[2] # self.class::HEADERS
