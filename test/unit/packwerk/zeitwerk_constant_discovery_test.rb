...
module Packwerk
  class ZeitwerkConstantDiscoveryTest < Minitest::Test
    ...
    test "raises with helpful message if there are errors resolving constants" do
      ...
      error = assert_raises(ZeitwerkConstantDiscovery::Error) do
    ...
    test "raises when validating constants and load paths contain no ruby files" do
      ...
      with_empty_load_paths = ZeitwerkConstantDiscovery.new(
