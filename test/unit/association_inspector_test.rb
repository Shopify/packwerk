...
module Packwerk
  class AssociationInspectorTest < Minitest::Test
    ...
    test "#association? understands custom associations" do
      ...
      inspector = Private::AssociationInspector.new(inflector: @inflector, custom_associations: [:has_lots])
    ...
    test "finds target constant for simple association" do
      ...
      inspector = Private::AssociationInspector.new(inflector: @inflector)
