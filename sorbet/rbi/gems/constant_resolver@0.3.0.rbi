...
#
# pkg:gem/constant_resolver#lib/constant_resolver/version.rb:3
class ConstantResolver
  ...
  #   )
  #
  # pkg:gem/constant_resolver#lib/constant_resolver.rb:46
  def initialize(root_path:, load_paths:, exclude: T.unsafe(nil), inflector: T.unsafe(nil)); end

  # @api private
  #
  # pkg:gem/constant_resolver#lib/constant_resolver.rb:122
  def config; end
  ...
  #
  # pkg:gem/constant_resolver#lib/constant_resolver.rb:78
  def file_map; end
  ...
  #
  # pkg:gem/constant_resolver#lib/constant_resolver.rb:63
  def resolve(const_name, current_namespace_path: T.unsafe(nil)); end

  private

  # pkg:gem/constant_resolver#lib/constant_resolver.rb:131
  def allowed?(path); end

  # pkg:gem/constant_resolver#lib/constant_resolver.rb:144
  def ambiguous_constant_message(const_name, paths); end

  # pkg:gem/constant_resolver#lib/constant_resolver.rb:135
  def coerce_load_paths(load_paths); end

  # pkg:gem/constant_resolver#lib/constant_resolver.rb:151
  def glob_path(path); end

  # pkg:gem/constant_resolver#lib/constant_resolver.rb:155
  def resolve_constant(const_name, current_namespace_path, original_name: T.unsafe(nil)); end

  # pkg:gem/constant_resolver#lib/constant_resolver.rb:168
  def resolve_traversing_namespace_path(const_name, current_namespace_path); end
end

# pkg:gem/constant_resolver#lib/constant_resolver.rb:19
class ConstantResolver::ConstantContext < ::Struct; end

# pkg:gem/constant_resolver#lib/constant_resolver.rb:21
class ConstantResolver::DefaultInflector
  # pkg:gem/constant_resolver#lib/constant_resolver.rb:22
  def camelize(string); end
end

# pkg:gem/constant_resolver#lib/constant_resolver.rb:18
class ConstantResolver::Error < ::StandardError; end

# pkg:gem/constant_resolver#lib/constant_resolver.rb:16
ConstantResolver::RUBY_FILES_GLOB = T.let(T.unsafe(nil), String)

# pkg:gem/constant_resolver#lib/constant_resolver/version.rb:4
