...
class RuboCop::Cop::Performance::ArraySemiInfiniteRangeSlice < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/array_semi_infinite_range_slice.rb:65
...
#
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/big_decimal_with_numeric_argument.rb:23
class RuboCop::Cop::Performance::BigDecimalWithNumericArgument < ::RuboCop::Cop::Base
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/big_decimal_with_numeric_argument.rb:29
  def big_decimal_with_numeric_argument?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/big_decimal_with_numeric_argument.rb:37
  def on_send(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/big_decimal_with_numeric_argument.rb:33
  def to_d?(param0 = T.unsafe(nil)); end
end

# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/big_decimal_with_numeric_argument.rb:26
RuboCop::Cop::Performance::BigDecimalWithNumericArgument::MSG = T.let(T.unsafe(nil), String)

# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/big_decimal_with_numeric_argument.rb:27
...
class RuboCop::Cop::Performance::BindCall < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/bind_call.rb:33
  def bind_with_call_method?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/bind_call.rb:41
  def on_send(node); end

  private

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/bind_call.rb:72
  def build_call_args(call_args_node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/bind_call.rb:65
  def correction_range(receiver, node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/bind_call.rb:59
...
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/bind_call.rb:31
...
#   end
#
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/block_given_with_explicit_block.rb:27
class RuboCop::Cop::Performance::BlockGivenWithExplicitBlock < ::RuboCop::Cop::Base
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/block_given_with_explicit_block.rb:35
  def on_send(node); end
...
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/block_given_with_explicit_block.rb:31
...
class RuboCop::Cop::Performance::CaseWhenSplat < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/case_when_splat.rb:66
  def on_case(case_node); end

  private

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/case_when_splat.rb:83
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/case_when_splat.rb:100
  def inline_fix_branch(corrector, when_node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/case_when_splat.rb:169
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/case_when_splat.rb:136
  def new_condition_with_then(node, new_condition); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/case_when_splat.rb:162
  def non_splat?(condition); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/case_when_splat.rb:91
  def range(node); end
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/case_when_splat.rb:118
  def reordering_correction(when_node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/case_when_splat.rb:95
  def replacement(conditions); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/case_when_splat.rb:148
  def splat_offenses(when_conditions); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/case_when_splat.rb:128
...
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/case_when_splat.rb:63
...
#
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/casecmp.rb:24
class RuboCop::Cop::Performance::Casecmp < ::RuboCop::Cop::Base
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/casecmp.rb:45
  def downcase_downcase(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/casecmp.rb:31
  def downcase_eq(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/casecmp.rb:38
  def eq_downcase(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/casecmp.rb:52
  def on_send(node); end

  private

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/casecmp.rb:84
  def autocorrect(corrector, node, replacement); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/casecmp.rb:88
  def build_good_method(method, arg, variable); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/casecmp.rb:67
  def take_method_apart(node); end
end

# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/casecmp.rb:29
RuboCop::Cop::Performance::Casecmp::CASE_METHODS = T.let(T.unsafe(nil), Array)

# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/casecmp.rb:27
RuboCop::Cop::Performance::Casecmp::MSG = T.let(T.unsafe(nil), String)

# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/casecmp.rb:28
...
#
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/chain_array_allocation.rb:37
...
#
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/chain_array_allocation.rb:45
...
#
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/chain_array_allocation.rb:33
...
#   [1,2].first(1) # => [1]
#
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/chain_array_allocation.rb:30
...
#   end
#
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/collection_literal_in_loop.rb:34
class RuboCop::Cop::Performance::CollectionLiteralInLoop < ::RuboCop::Cop::Base
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/collection_literal_in_loop.rb:74
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/collection_literal_in_loop.rb:90
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/collection_literal_in_loop.rb:112
  def keyword_loop?(type); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/collection_literal_in_loop.rb:122
  def literal_class(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/collection_literal_in_loop.rb:106
  def loop?(ancestor, node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/collection_literal_in_loop.rb:134
  def min_size; end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/collection_literal_in_loop.rb:116
  def node_within_enumerable_loop?(node, ancestor); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/collection_literal_in_loop.rb:97
...
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/collection_literal_in_loop.rb:56
RuboCop::Cop::Performance::CollectionLiteralInLoop::ARRAY_METHODS = T.let(T.unsafe(nil), Set)

# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/collection_literal_in_loop.rb:41
...
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/collection_literal_in_loop.rb:39
RuboCop::Cop::Performance::CollectionLiteralInLoop::LOOP_TYPES = T.let(T.unsafe(nil), Array)

# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/collection_literal_in_loop.rb:35
...
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/collection_literal_in_loop.rb:58
RuboCop::Cop::Performance::CollectionLiteralInLoop::NONMUTATING_HASH_METHODS = T.let(T.unsafe(nil), Array)

# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/collection_literal_in_loop.rb:38
...
#
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/compare_with_block.rb:26
class RuboCop::Cop::Performance::CompareWithBlock < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/compare_with_block.rb:105
  def compare_range(send, node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/compare_with_block.rb:84
  def message(send, method, var_a, var_b, args); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/compare_with_block.rb:69
...
class RuboCop::Cop::Performance::ConstantRegexp < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/constant_regexp.rb:57
  def regexp_escape?(param0 = T.unsafe(nil)); end

  private

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/constant_regexp.rb:62
  def include_interpolated_const?(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/constant_regexp.rb:53
...
#
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/count.rb:49
class RuboCop::Cop::Performance::Count < ::RuboCop::Cop::Base
  include ::RuboCop::Cop::RangeHelp
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/count.rb:56
  def count_candidate?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/count.rb:63
  def on_send(node); end
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/count.rb:90
  def eligible_node?(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/count.rb:94
...
class RuboCop::Cop::Performance::DeletePrefix < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/delete_prefix.rb:70
  def on_send(node); end
end
...
class RuboCop::Cop::Performance::DeleteSuffix < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/delete_suffix.rb:70
  def on_send(node); end
end
...
class RuboCop::Cop::Performance::Detect < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/detect.rb:69
  def accept_first_call?(receiver, body); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/detect.rb:101
  def autocorrect(corrector, node, replacement); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/detect.rb:127
  def lazy?(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/detect.rb:112
  def message_for_method(method, index); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/detect.rb:123
  def preferred_method; end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/detect.rb:78
  def register_offense(node, receiver, second_method, index); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/detect.rb:93
...
#   str.ends_with?(var1, var2)
#
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/double_start_end_with.rb:41
class RuboCop::Cop::Performance::DoubleStartEndWith < ::RuboCop::Cop::Base
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/double_start_end_with.rb:97
  def check_with_active_support_aliases(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/double_start_end_with.rb:47
  def on_or(node); end
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/double_start_end_with.rb:61
  def autocorrect(corrector, first_call_args, second_call_args, combined_args); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/double_start_end_with.rb:87
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/double_start_end_with.rb:77
  def message(node, receiver, method, combined_args); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/double_start_end_with.rb:69
  def process_source(node); end
end

# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/double_start_end_with.rb:44
...
class RuboCop::Cop::Performance::EndWith < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/end_with.rb:76
  def on_match_with_lvasgn(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/end_with.rb:63
  def on_send(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/end_with.rb:57
...
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/end_with.rb:55
...
class RuboCop::Cop::Performance::FixedSize < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/fixed_size.rb:72
  def allowed_argument?(arg); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/fixed_size.rb:76
  def allowed_parent?(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/fixed_size.rb:68
  def allowed_variable?(var); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/fixed_size.rb:86
  def contains_double_splat?(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/fixed_size.rb:80
  def contains_splat?(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/fixed_size.rb:92
...
class RuboCop::Cop::Performance::FlatMap < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/flat_map.rb:71
  def autocorrect(corrector, node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/flat_map.rb:52
  def offense_for_levels(node, map_node, first_method, flatten); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/flat_map.rb:58
  def offense_for_method(node, map_node, first_method, flatten); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/flat_map.rb:62
...
class RuboCop::Cop::Performance::InefficientHashSearch < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/inefficient_hash_search.rb:91
  def autocorrect_argument(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/inefficient_hash_search.rb:95
  def autocorrect_hash_expression(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/inefficient_hash_search.rb:73
  def autocorrect_method(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/inefficient_hash_search.rb:80
  def current_method(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/inefficient_hash_search.rb:69
  def message(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/inefficient_hash_search.rb:84
...
#   ary.compact.map(&:foo)
#
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/map_compact.rb:30
class RuboCop::Cop::Performance::MapCompact < ::RuboCop::Cop::Base
  include ::RuboCop::Cop::RangeHelp
  extend ::RuboCop::Cop::AutoCorrector
  extend ::RuboCop::Cop::TargetRubyVersion

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/map_compact.rb:40
  def map_compact(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/map_compact.rb:53
  def on_send(node); end

  private

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/map_compact.rb:89
  def compact_method_with_final_newline_range(compact_method_range); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/map_compact.rb:85
  def invoke_method_after_map_compact_on_same_line?(compact_node, chained_method); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/map_compact.rb:81
  def map_method_and_compact_method_on_same_line?(map_node, compact_node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/map_compact.rb:67
  def remove_compact_method(corrector, map_node, compact_node, chained_method); end
end

# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/map_compact.rb:35
...
class RuboCop::Cop::Performance::OpenStruct < ::RuboCop::Cop::Base
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/open_struct.rb:43
  def on_send(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/open_struct.rb:39
...
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/open_struct.rb:37
...
#
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/range_include.rb:28
class RuboCop::Cop::Performance::RangeInclude < ::RuboCop::Cop::Base
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/range_include.rb:43
  def on_send(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/range_include.rb:39
  def range_include(param0 = T.unsafe(nil)); end
end

# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/range_include.rb:31
...
class RuboCop::Cop::Performance::RedundantBlockCall < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_block_call.rb:58
  def on_defs(node); end

  private

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_block_call.rb:97
  def args_include_block_pass?(blockcall); end

  # offenses are registered on the `block.call` nodes
  #
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_block_call.rb:63
  def autocorrect(corrector, node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_block_call.rb:81
  def calls_to_report(argname, body); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_block_call.rb:91
...
#   items.all?(pattern)
#
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_equality_comparison_block.rb:26
class RuboCop::Cop::Performance::RedundantEqualityComparisonBlock < ::RuboCop::Cop::Base
  extend ::RuboCop::Cop::AutoCorrector
  extend ::RuboCop::Cop::TargetRubyVersion

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_equality_comparison_block.rb:38
  def on_block(node); end

  private

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_equality_comparison_block.rb:76
  def new_argument(block_argument, block_body); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_equality_comparison_block.rb:99
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_equality_comparison_block.rb:66
  def same_block_argument_and_is_a_argument?(block_body, block_argument); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_equality_comparison_block.rb:90
...
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_equality_comparison_block.rb:35
RuboCop::Cop::Performance::RedundantEqualityComparisonBlock::COMPARISON_METHODS = T.let(T.unsafe(nil), Array)

# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_equality_comparison_block.rb:36
RuboCop::Cop::Performance::RedundantEqualityComparisonBlock::IS_A_METHODS = T.let(T.unsafe(nil), Array)

# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_equality_comparison_block.rb:32
RuboCop::Cop::Performance::RedundantEqualityComparisonBlock::MSG = T.let(T.unsafe(nil), String)

# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_equality_comparison_block.rb:34
...
class RuboCop::Cop::Performance::RedundantMatch < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_match.rb:29
  def match_call?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_match.rb:38
  def on_send(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_match.rb:34
  def only_truthiness_matters?(param0 = T.unsafe(nil)); end

  private

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_match.rb:50
  def autocorrect(corrector, node); end
end
...
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_match.rb:25
...
class RuboCop::Cop::Performance::RedundantMerge < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_merge.rb:47
  def modifier_flow_control?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_merge.rb:51
  def on_send(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_merge.rb:43
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_merge.rb:78
  def each_redundant_merge(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_merge.rb:150
  def indent_width; end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_merge.rb:97
  def kwsplat_used?(pairs); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_merge.rb:146
  def leading_spaces(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_merge.rb:154
  def max_key_value_pairs; end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_merge.rb:70
  def message(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_merge.rb:86
  def non_redundant_merge?(node, receiver, pairs); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_merge.rb:93
  def non_redundant_pairs?(receiver, pairs); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_merge.rb:101
  def non_redundant_value_used?(receiver, node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_merge.rb:134
...
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_merge.rb:33
...
#
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_merge.rb:160
class RuboCop::Cop::Performance::RedundantMerge::EachWithObjectInspector
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_merge.rb:168
  def value_used?; end

  private

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_merge.rb:178
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_merge.rb:182
  def second_argument; end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_merge.rb:189
...
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_merge.rb:37
...
class RuboCop::Cop::Performance::RedundantSortBlock < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_sort_block.rb:35
...
class RuboCop::Cop::Performance::RedundantSplitRegexpArgument < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_split_regexp_argument.rb:41
  def determinist_regexp?(regexp_node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_split_regexp_argument.rb:45
...
#
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_string_chars.rb:42
class RuboCop::Cop::Performance::RedundantStringChars < ::RuboCop::Cop::Base
  include ::RuboCop::Cop::RangeHelp
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_string_chars.rb:53
  def on_send(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_string_chars.rb:49
  def redundant_chars_call?(param0 = T.unsafe(nil)); end

  private

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_string_chars.rb:108
  def build_bad_method(method, args); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_string_chars.rb:121
  def build_call_args(call_args_node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_string_chars.rb:83
  def build_good_method(method, args); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_string_chars.rb:96
  def build_good_method_for_brackets_or_first_method(method, args); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_string_chars.rb:77
  def build_message(method, args); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_string_chars.rb:73
  def correction_range(receiver, node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_string_chars.rb:69
  def offense_range(receiver, node); end
end

# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/redundant_string_chars.rb:46
...
class RuboCop::Cop::Performance::RegexpMatch < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/regexp_match.rb:150
  def check_condition(cond); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/regexp_match.rb:254
  def correct_operator(corrector, recv, arg, oper = T.unsafe(nil)); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/regexp_match.rb:279
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/regexp_match.rb:243
  def match_gvar?(sym); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/regexp_match.rb:173
  def message(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/regexp_match.rb:213
  def modifier_form?(match_node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/regexp_match.rb:199
  def next_match_pos(body, match_node_pos, scope_root); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/regexp_match.rb:186
  def range_to_search_for_last_matches(match_node, body, scope_root); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/regexp_match.rb:263
  def replace_with_match_predicate_method(corrector, recv, arg, op_range); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/regexp_match.rb:225
  def scope_body(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/regexp_match.rb:237
  def scope_root(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/regexp_match.rb:274
...
class RuboCop::Cop::Performance::ReverseEach < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/reverse_each.rb:53
  def offense_range(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/reverse_each.rb:47
...
class RuboCop::Cop::Performance::ReverseFirst < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/reverse_first.rb:63
  def build_bad_method(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/reverse_first.rb:55
  def build_good_method(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/reverse_first.rb:49
  def build_message(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/reverse_first.rb:45
  def correction_range(receiver, node); end
end
...
class RuboCop::Cop::Performance::SelectMap < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/select_map.rb:31
  def on_send(node); end

  private

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/select_map.rb:44
...
class RuboCop::Cop::Performance::SortReverse < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/sort_reverse.rb:38
  def message(var_a, var_b); end
end
...
class RuboCop::Cop::Performance::Squeeze < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/squeeze.rb:41
  def on_send(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/squeeze.rb:32
...
class RuboCop::Cop::Performance::StartWith < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/start_with.rb:76
  def on_match_with_lvasgn(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/start_with.rb:63
  def on_send(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/start_with.rb:57
  def redundant_regex?(param0 = T.unsafe(nil)); end
end
...
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/start_with.rb:55
...
#   instance_variable_get(:@ivar)
#
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/string_identifier_argument.rb:25
class RuboCop::Cop::Performance::StringIdentifierArgument < ::RuboCop::Cop::Base
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/string_identifier_argument.rb:46
  def on_send(node); end
end

# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/string_identifier_argument.rb:28
...
#   'abc'.include?('ab')
#
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/string_include.rb:22
class RuboCop::Cop::Performance::StringInclude < ::RuboCop::Cop::Base
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/string_include.rb:46
  def on_match_with_lvasgn(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/string_include.rb:34
  def on_send(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/string_include.rb:28
  def redundant_regex?(param0 = T.unsafe(nil)); end

  private

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/string_include.rb:50
  def literal?(regex_str); end
end

# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/string_include.rb:25
...
class RuboCop::Cop::Performance::StringReplacement < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/string_replacement.rb:83
  def accept_first_param?(first_param); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/string_replacement.rb:78
  def accept_second_param?(second_param); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/string_replacement.rb:59
  def autocorrect(corrector, node); end
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/string_replacement.rb:150
  def method_suffix(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/string_replacement.rb:48
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/string_replacement.rb:154
  def remove_second_param(corrector, node, first_param); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/string_replacement.rb:69
...
class RuboCop::Cop::Performance::Sum < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/sum.rb:99
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/sum.rb:111
  def on_block(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/sum.rb:104
  def on_send(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/sum.rb:79
  def sum_candidate?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/sum.rb:83
  def sum_map_candidate?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/sum.rb:92
  def sum_with_block_candidate?(param0 = T.unsafe(nil)); end

  private

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/sum.rb:156
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/sum.rb:169
  def autocorrect_sum_map(corrector, sum, map, init); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/sum.rb:245
  def build_block_bad_method(method, init, var_acc, var_elem, body); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/sum.rb:212
  def build_block_message(send, init, var_acc, var_elem, body); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/sum.rb:218
  def build_good_method(init, block_pass = T.unsafe(nil)); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/sum.rb:231
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/sum.rb:205
  def build_sum_map_message(method, init); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/sum.rb:151
  def empty_array_literal?(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/sum.rb:126
  def handle_sum_candidate(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/sum.rb:139
  def handle_sum_map_candidate(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/sum.rb:256
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/sum.rb:182
  def sum_method_range(node); end
end

# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/sum.rb:74
RuboCop::Cop::Performance::Sum::MSG = T.let(T.unsafe(nil), String)

# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/sum.rb:75
...
class RuboCop::Cop::Performance::TimesMap < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/times_map.rb:44
  def on_block(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/times_map.rb:40
  def on_send(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/times_map.rb:70
  def times_map_call(param0 = T.unsafe(nil)); end

  private

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/times_map.rb:50
  def check(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/times_map.rb:61
...
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/times_map.rb:38
...
class RuboCop::Cop::Performance::UnfreezeString < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/unfreeze_string.rb:44
  def on_send(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/unfreeze_string.rb:37
  def string_new?(param0 = T.unsafe(nil)); end

  private

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/unfreeze_string.rb:57
  def string_value(node); end
end

# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/unfreeze_string.rb:30
RuboCop::Cop::Performance::UnfreezeString::MSG = T.let(T.unsafe(nil), String)

# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/unfreeze_string.rb:31
...
class RuboCop::Cop::Performance::UriDefaultParser < ::RuboCop::Cop::Base
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/uri_default_parser.rb:28
  def on_send(node); end

  # pkg:gem/rubocop-performance#lib/rubocop/cop/performance/uri_default_parser.rb:22
...
# pkg:gem/rubocop-performance#lib/rubocop/cop/performance/uri_default_parser.rb:20
...
module RuboCop::Cop::SortBlock
  ...
  # pkg:gem/rubocop-performance#lib/rubocop/cop/mixin/sort_block.rb:23
...
# pkg:gem/rubocop-performance#lib/rubocop/performance.rb:8
RuboCop::Performance::CONFIG = T.let(T.unsafe(nil), Hash)

# pkg:gem/rubocop-performance#lib/rubocop/performance.rb:7
RuboCop::Performance::CONFIG_DEFAULT = T.let(T.unsafe(nil), Pathname)

# Because RuboCop doesn't yet support plugins, we have to monkey patch in a
# bit of our configuration.
#
# pkg:gem/rubocop-performance#lib/rubocop/performance/inject.rb:7
module RuboCop::Performance::Inject
  class << self
    # pkg:gem/rubocop-performance#lib/rubocop/performance/inject.rb:8
    def defaults!; end
  end
end

# pkg:gem/rubocop-performance#lib/rubocop/performance.rb:6
