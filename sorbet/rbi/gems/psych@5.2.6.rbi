...
module Psych
  class << self
    ...
    # :stopdoc:
    #
    # pkg:gem/psych#lib/psych.rb:722
    def add_domain_type(domain, type_tag, &block); end

    # pkg:gem/psych#lib/psych.rb:738
    def add_tag(tag, klass); end

    # pkg:gem/psych#lib/psych.rb:754
    def config; end

    # pkg:gem/psych#lib/psych.rb:766
    def domain_types; end

    # pkg:gem/psych#lib/psych.rb:778
    ...
    #
    # pkg:gem/psych#lib/psych.rb:514
    ...
    #
    # pkg:gem/psych#lib/psych.rb:612
    def dump_stream(*objects); end

    # pkg:gem/psych#lib/psych.rb:762
    def dump_tags; end

    # pkg:gem/psych#lib/psych.rb:774
    ...
    #
    # pkg:gem/psych#lib/psych.rb:715
    ...
    #   list # => ['foo', 'bar']
    #
    # pkg:gem/psych#lib/psych.rb:643
    def load_stream(yaml, filename: T.unsafe(nil), fallback: T.unsafe(nil), **kwargs); end

    # pkg:gem/psych#lib/psych.rb:758
    def load_tags; end

    # pkg:gem/psych#lib/psych.rb:770
    ...
    #
    # pkg:gem/psych#lib/psych.rb:399
    ...
    # Raises a Psych::SyntaxError when a YAML syntax error is detected.
    #
    # pkg:gem/psych#lib/psych.rb:411
    ...
    # See Psych::Nodes for more information about YAML AST.
    #
    # pkg:gem/psych#lib/psych.rb:453
    def parse_stream(yaml, filename: T.unsafe(nil), &block); end

    # Returns a default parser
    #
    # pkg:gem/psych#lib/psych.rb:420
    def parser; end

    # pkg:gem/psych#lib/psych.rb:734
    ...
    #
    # pkg:gem/psych#lib/psych.rb:704
    ...
    #
    # pkg:gem/psych#lib/psych.rb:693
...
class Psych::ScalarScanner
  ...
  #
  # pkg:gem/psych#lib/psych/scalar_scanner.rb:108
  def parse_int(string); end

  # Parse and return a Time from +string+
  #
  # pkg:gem/psych#lib/psych/scalar_scanner.rb:114
...
# pkg:gem/psych#lib/psych/visitors/to_ruby.rb:469
class Psych::Visitors::NoAliasRuby < ::Psych::Visitors::ToRuby
  # pkg:gem/psych#lib/psych/visitors/to_ruby.rb:470
  def visit_Psych_Nodes_Alias(o); end
end
...
class Psych::Visitors::ToRuby < ::Psych::Visitors::Visitor
  ...
  # pkg:gem/psych#lib/psych/visitors/to_ruby.rb:164
  def visit_Psych_Nodes_Mapping(o); end

  # pkg:gem/psych#lib/psych/visitors/to_ruby.rb:128
  def visit_Psych_Nodes_Scalar(o); end
  ...
  # pkg:gem/psych#lib/psych/visitors/to_ruby.rb:369
  def allocate_anon_data(node, members); end

  # pkg:gem/psych#lib/psych.rb:15
  def build_exception(_arg0, _arg1); end

  # pkg:gem/psych#lib/psych/visitors/to_ruby.rb:434
  ...
  # pkg:gem/psych#lib/psych/visitors/to_ruby.rb:451
  def init_with(o, h, node); end

  # pkg:gem/psych#lib/psych/visitors/to_ruby.rb:443
  def merge_key(hash, key, val); end

  # pkg:gem/psych#lib/psych/visitors/to_ruby.rb:358
  ...
  #
  # pkg:gem/psych#lib/psych/visitors/to_ruby.rb:464
  def resolve_class(klassname); end

  # pkg:gem/psych#lib/psych/visitors/to_ruby.rb:446
  def revive(klass, node); end

  # pkg:gem/psych#lib/psych/visitors/to_ruby.rb:374
  def revive_data_members(hash, o); end

  # pkg:gem/psych#lib/psych/visitors/to_ruby.rb:383
...
# pkg:gem/psych#lib/psych/core_ext.rb:26
class Set
  include ::Enumerable

  # pkg:gem/psych#lib/psych/core_ext.rb:27
  def encode_with(coder); end

  # pkg:gem/psych#lib/psych/core_ext.rb:36
