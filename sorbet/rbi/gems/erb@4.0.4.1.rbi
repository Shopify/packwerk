...
class ERB
  ...
  #   end
  #
  # pkg:gem/erb#lib/erb.rb:485
  def def_module(methodname = T.unsafe(nil)); end

  # The encoding to eval
  #
  # pkg:gem/erb#lib/erb.rb:370
  def encoding; end

  # The optional _filename_ argument passed to Kernel#eval when the ERB code
  # is run
  #
  # pkg:gem/erb#lib/erb.rb:374
  def filename; end
  ...
  #   #   from file.erb:4
  #
  # pkg:gem/erb#lib/erb.rb:395
  def location=(_arg0); end

  # Creates a new compiler for ERB.  See ERB::Compiler.new for details
  #
  # pkg:gem/erb#lib/erb.rb:362
  ...
  # code evaluation.
  #
  # pkg:gem/erb#lib/erb.rb:425
  def result(b = T.unsafe(nil)); end

  # Render a template on a new toplevel binding with local variables specified
  # by a Hash object.
  #
  # pkg:gem/erb#lib/erb.rb:434
  def result_with_hash(hash); end

  # Generate results and print them. (see ERB#result)
  #
  # pkg:gem/erb#lib/erb.rb:413
  ...
  #
  # pkg:gem/erb#lib/erb.rb:405
  def set_eoutvar(compiler, eoutvar = T.unsafe(nil)); end

  # The Ruby code generated by ERB
  #
  # pkg:gem/erb#lib/erb.rb:367
  def src; end
  ...
  #
  # pkg:gem/erb#lib/erb.rb:446
  def new_toplevel(vars = T.unsafe(nil)); end

  class << self
    # Returns revision information for the erb.rb module.
    #
    # pkg:gem/erb#lib/erb.rb:267
    def version; end
  end
end
...
class ERB::Compiler
  ...
  # pkg:gem/erb#lib/erb/compiler.rb:309
  def add_insert_cmd(out, content); end

  # pkg:gem/erb#lib/erb/compiler.rb:305
  ...
  # pkg:gem/erb#lib/erb/compiler.rb:375
  def compile_content(stag, out); end

  # pkg:gem/erb#lib/erb/compiler.rb:362
  def compile_etag(etag, out, scanner); end

  # pkg:gem/erb#lib/erb/compiler.rb:338
  ...
  # pkg:gem/erb#lib/erb/compiler.rb:421
  def make_scanner(src); end

  # pkg:gem/erb#lib/erb/compiler.rb:434
  def percent; end
  ...
  # pkg:gem/erb#lib/erb/compiler.rb:392
  def prepare_trim_mode(mode); end

  # The command to handle text that ends with a newline
  #
  # pkg:gem/erb#lib/erb/compiler.rb:437
  def put_cmd; end
  ...
  #
  # pkg:gem/erb#lib/erb/compiler.rb:451
  def content; end
  ...
  # pkg:gem/erb#lib/erb/compiler.rb:453
  def detect_magic_comment(s, enc = T.unsafe(nil)); end

  # pkg:gem/erb#lib/erb/compiler.rb:469
  def warn_invalid_trim_mode(mode, uplevel:); end
end

# pkg:gem/erb#lib/erb/compiler.rb:272
class ERB::Compiler::Buffer
  ...
  # pkg:gem/erb#lib/erb/compiler.rb:285
  def push(cmd); end

  # pkg:gem/erb#lib/erb/compiler.rb:283
  def script; end
end

# pkg:gem/erb#lib/erb/compiler.rb:248
...
class ERB::Compiler::Scanner
  ...
  # pkg:gem/erb#lib/erb/compiler.rb:111
  def scan; end
  ...
  class << self
    # pkg:gem/erb#lib/erb/compiler.rb:91
    def default_scanner=(klass); end

    # pkg:gem/erb#lib/erb/compiler.rb:95
    def make_scanner(src, trim_mode, percent); end

    # pkg:gem/erb#lib/erb/compiler.rb:88
    def regist_scanner(klass, trim_mode, percent); end

    # pkg:gem/erb#lib/erb/compiler.rb:85
...
# pkg:gem/erb#lib/erb/compiler.rb:100
ERB::Compiler::Scanner::DEFAULT_STAGS = T.let(T.unsafe(nil), Array)

# pkg:gem/erb#lib/erb/compiler.rb:234
...
class ERB::Compiler::TrimScanner < ::ERB::Compiler::Scanner
  ...
  # pkg:gem/erb#lib/erb/compiler.rb:204
  def explicit_trim_line(line); end

  # pkg:gem/erb#lib/erb/compiler.rb:223
  def is_erb_stag?(s); end

  # pkg:gem/erb#lib/erb/compiler.rb:146
  def percent_line(line, &block); end

  # pkg:gem/erb#lib/erb/compiler.rb:134
  def scan(&block); end

  # pkg:gem/erb#lib/erb/compiler.rb:159
  def scan_line(line); end

  # pkg:gem/erb#lib/erb/compiler.rb:168
  def trim_line1(line); end

  # pkg:gem/erb#lib/erb/compiler.rb:182
...
#
# pkg:gem/erb#lib/erb/util.rb:27
module ERB::Util
  ...
  # pkg:gem/erb#lib/erb/util.rb:60
  def u(s); end
  ...
  #
  # pkg:gem/erb#lib/erb/util.rb:57
  def url_encode(s); end

  class << self
    # pkg:gem/erb#lib/erb/util.rb:43
    def h(s); end

    # pkg:gem/erb#lib/erb/util.rb:41
    def html_escape(s); end

    # pkg:gem/erb#lib/erb/util.rb:61
    def u(s); end
    ...
    #   Programming%20Ruby%3A%20%20The%20Pragmatic%20Programmer%27s%20Guide
    #
    # pkg:gem/erb#lib/erb/util.rb:62
    def url_encode(s); end
  end
end

# pkg:gem/erb#lib/erb/version.rb:3
