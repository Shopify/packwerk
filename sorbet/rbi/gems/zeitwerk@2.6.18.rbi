...
# pkg:gem/zeitwerk#lib/zeitwerk/kernel.rb:3
module Kernel
  private

  # @sig (String) -> true | false
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/kernel.rb:23
  ...
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/kernel.rb:17
  ...
  class << self
    ...
    # pkg:gem/zeitwerk#lib/zeitwerk/kernel.rb:19
...
module Zeitwerk
  class << self
    ...
    # @sig () -> void
    #
    # pkg:gem/zeitwerk#lib/zeitwerk.rb:22
    def with_loader; end
  end
end
...
class Zeitwerk::Cref
  ...
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/cref.rb:23
  def initialize(mod, cname); end

  # @sig (String) -> bool
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/cref.rb:74
  def autoload(abspath); end

  # @sig () -> String?
  # @sig () -> String?
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/cref.rb:68
  def autoload?; end

  # @sig Symbol
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/cref.rb:17
  def cname; end

  # @sig () -> bool
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/cref.rb:79
  def defined?; end

  # @raise [NameError]
  # @sig () -> Object
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/cref.rb:90
  def get; end
  ...
  # @sig () -> String
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/cref.rb:34
  def path; end

  # @raise [NameError]
  # @sig () -> void
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/cref.rb:96
  def remove; end

  # @sig (Object) -> Object
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/cref.rb:84
  def set(value); end
end
...
#
# pkg:gem/zeitwerk#lib/zeitwerk/explicit_namespace.rb:11
module Zeitwerk::ExplicitNamespace
  extend ::Zeitwerk::RealModName

  class << self
    # pkg:gem/zeitwerk#lib/zeitwerk/explicit_namespace.rb:35
    def __register(cpath, loader); end

    # pkg:gem/zeitwerk#lib/zeitwerk/explicit_namespace.rb:53
    def __registered?(cpath); end

    # pkg:gem/zeitwerk#lib/zeitwerk/explicit_namespace.rb:45
    ...
    #
    # pkg:gem/zeitwerk#lib/zeitwerk/explicit_namespace.rb:20
    def cpaths; end

    # @sig () -> void
    #
    # pkg:gem/zeitwerk#lib/zeitwerk/explicit_namespace.rb:58
    def disable_tracer_if_unneeded; end

    # @sig Mutex
    #
    # pkg:gem/zeitwerk#lib/zeitwerk/explicit_namespace.rb:24
    def mutex; end
    ...
    # @sig (TracePoint) -> void
    #
    # pkg:gem/zeitwerk#lib/zeitwerk/explicit_namespace.rb:65
    def tracepoint_class_callback(event); end

    # @sig TracePoint
    #
    # pkg:gem/zeitwerk#lib/zeitwerk/explicit_namespace.rb:28
    def tracer; end
...
module Zeitwerk::Internal
  # pkg:gem/zeitwerk#lib/zeitwerk/internal.rb:5
...
class Zeitwerk::Loader
  ...
  # @sig () -> Hash[String, String]
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:238
  def all_expected_cpaths; end

  # @sig (String | Pathname) -> String?
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:268
  ...
  # @sig () -> void
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:224
  def reload; end
  ...
  # @sig () -> void
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:120
  def setup; end
  ...
  # @sig () -> void
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:146
  def unload; end
  ...
  # @sig (String) -> bool
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:319
  ...
  # @sig () -> Array[String]
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:327
  ...
  # @sig () -> void
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:335
  def unregister; end
  ...
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:491
  def autoload_file(cref, file); end

  # @sig (Module, Symbol) -> String?
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:544
  def autoload_path_set_by_me_for?(cref); end

  # @sig (Module, Symbol, String) -> void
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:462
  ...
  # @sig Array[String]
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:42
  ...
  # @sig (Module, Symbol, String) -> void
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:523
  def define_autoload(cref, abspath); end

  # @sig (String, Module) -> void
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:444
  ...
  # @sig Mutex
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:93
  def mutex; end
  ...
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:78
  ...
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:512
  ...
  # @sig (String) -> void
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:553
  def register_explicit_namespace(cpath); end

  # @sig (String, Object, String) -> void
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:582
  ...
  # @sig Set[String]
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:89
  ...
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:60
  def to_unload; end

  # @sig (Module, Symbol) -> void
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:589
  ...
  class << self
    ...
    # @sig () -> Array[String]
    #
    # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:438
    def all_dirs; end

    # @sig #call | #debug | nil
    #
    # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:354
    ...
    # @sig () -> void
    #
    # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:410
    ...
    # @sig (Module) -> void
    #
    # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:424
    ...
    # @sig (bool) -> Zeitwerk::GemLoader
    #
    # pkg:gem/zeitwerk#lib/zeitwerk/loader.rb:393
...
module Zeitwerk::Loader::Callbacks
  ...
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/callbacks.rb:40
  def __on_dir_autoloaded(dir); end

  # pkg:gem/zeitwerk#lib/zeitwerk/loader/callbacks.rb:10
  ...
  # @sig (Module) -> void
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/callbacks.rb:80
  ...
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/callbacks.rb:91
...
module Zeitwerk::Loader::Config
  ...
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/config.rb:86
  def initialize; end

  # pkg:gem/zeitwerk#lib/zeitwerk/loader/config.rb:296
  ...
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/config.rb:156
  ...
  # @sig (*(String | Pathname | Array[String | Pathname])) -> void
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/config.rb:198
  ...
  # @sig () -> void
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/config.rb:177
  ...
  # @sig (*(String | Pathname | Array[String | Pathname])) -> void
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/config.rb:205
  ...
  # @sig () -> void
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/config.rb:288
  def log!; end
  ...
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/config.rb:252
  ...
  # @sig () { () -> void } -> void
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/config.rb:228
  ...
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/config.rb:277
  ...
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/config.rb:111
  def push_dir(path, namespace: T.unsafe(nil)); end

  # @sig () -> bool
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/config.rb:190
  ...
  # @sig () -> String
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/config.rb:135
  def tag; end
  ...
  # @sig (#to_s) -> void
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/config.rb:142
  def tag=(tag); end
  ...
  # @sig Set[String]
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/config.rb:57
  ...
  # @sig Set[String]
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/config.rb:50
  ...
  # @sig Set[String]
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/config.rb:63
  def eager_load_exclusions; end

  # @sig (String) -> bool
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/config.rb:326
  ...
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/config.rb:344
  ...
  # @sig (String) -> bool
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/config.rb:309
  ...
  # @sig Array[{ () -> void }]
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/config.rb:69
  ...
  #      Hash[Symbol, Array[{ (String, Object, String) -> void }]]
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/config.rb:83
  def on_unload_callbacks; end

  # @sig () -> void
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/config.rb:361
  def recompute_collapse_dirs; end

  # @sig () -> void
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/config.rb:356
  def recompute_ignored_paths; end

  # @sig (String) -> bool
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/config.rb:321
...
module Zeitwerk::Loader::Helpers
  ...
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/helpers.rb:110
  def cname_for(basename, abspath); end

  # @sig (String) -> bool
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/helpers.rb:85
  def dir?(path); end
  ...
  # @sig (String) -> bool
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/helpers.rb:90
  ...
  # @sig (String) -> bool
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/helpers.rb:80
  def ruby?(path); end

  # @sig (String) { (String) -> void } -> void
  #
  # pkg:gem/zeitwerk#lib/zeitwerk/loader/helpers.rb:95
  def walk_up(abspath); end
end

# --- Inflection --------------------------------------------------------------------------------
#
# pkg:gem/zeitwerk#lib/zeitwerk/loader/helpers.rb:105
...
# pkg:gem/zeitwerk#lib/zeitwerk/error.rb:13
class Zeitwerk::NameError < ::NameError; end

# pkg:gem/zeitwerk#lib/zeitwerk/null_inflector.rb:1
class Zeitwerk::NullInflector
  # pkg:gem/zeitwerk#lib/zeitwerk/null_inflector.rb:2
  def camelize(basename, _abspath); end
end

# pkg:gem/zeitwerk#lib/zeitwerk/real_mod_name.rb:3
module Zeitwerk::RealModName
  # pkg:gem/zeitwerk#lib/zeitwerk/real_mod_name.rb:14
  def real_mod_name(mod); end
end

# pkg:gem/zeitwerk#lib/zeitwerk/real_mod_name.rb:4
...
module Zeitwerk::Registry
  class << self
    ...
    # @sig Hash[String, Zeitwerk::Loader]
    #
    # pkg:gem/zeitwerk#lib/zeitwerk/registry.rb:26
    def autoloads; end
    ...
    # @sig Hash[String, Zeitwerk::Loader]
    #
    # pkg:gem/zeitwerk#lib/zeitwerk/registry.rb:17
    def gem_loaders_by_root_file; end

    # @private
    # @sig (String) -> String?
    #
    # pkg:gem/zeitwerk#lib/zeitwerk/registry.rb:113
    ...
    #
    # pkg:gem/zeitwerk#lib/zeitwerk/registry.rb:65
    def inceptions; end

    # @private
    # @sig (String) -> Zeitwerk::Loader?
    #
    # pkg:gem/zeitwerk#lib/zeitwerk/registry.rb:124
    ...
    # @sig (String) -> Zeitwerk::Loader
    #
    # pkg:gem/zeitwerk#lib/zeitwerk/registry.rb:89
    ...
    #
    # pkg:gem/zeitwerk#lib/zeitwerk/registry.rb:11
    def loaders; end

    # @private
    # @sig (Zeitwerk::Loader) -> void
    #
    # pkg:gem/zeitwerk#lib/zeitwerk/registry.rb:130
    def on_unload(loader); end

    # @private
    # @sig (Zeitwerk::Loader, String) -> String
    #
    # pkg:gem/zeitwerk#lib/zeitwerk/registry.rb:95
    def register_autoload(loader, abspath); end

    # @private
    # @sig (String, String, Zeitwerk::Loader) -> void
    #
    # pkg:gem/zeitwerk#lib/zeitwerk/registry.rb:107
    ...
    # @sig (Zeitwerk::Loader) -> void
    #
    # pkg:gem/zeitwerk#lib/zeitwerk/registry.rb:71
    def register_loader(loader); end

    # @private
    # @sig (String) -> void
    #
    # pkg:gem/zeitwerk#lib/zeitwerk/registry.rb:101
...
class Zeitwerk::ReloadingDisabledError < ::Zeitwerk::Error
  # pkg:gem/zeitwerk#lib/zeitwerk/error.rb:8
  def initialize; end
end

# pkg:gem/zeitwerk#lib/zeitwerk/error.rb:16
class Zeitwerk::SetupRequired < ::Zeitwerk::Error
  # pkg:gem/zeitwerk#lib/zeitwerk/error.rb:17
  def initialize; end
end

# pkg:gem/zeitwerk#lib/zeitwerk/version.rb:4
