...
# pkg:gem/minitest-focus#lib/minitest/focus.rb:3
class Minitest::Test < ::Minitest::Runnable
  ...
  class << self
    # pkg:gem/minitest-focus#lib/minitest/focus.rb:10
    def add_to_filter(name); end

    # pkg:gem/minitest-focus#lib/minitest/focus.rb:14
    ...
    #   end
    #
    # pkg:gem/minitest-focus#lib/minitest/focus.rb:40
    def focus(name = T.unsafe(nil)); end

    # Sets a one-off method_added callback to set focus on the method
    # defined next.
    #
    # pkg:gem/minitest-focus#lib/minitest/focus.rb:52
    def set_focus_trap; end
  end
end

# pkg:gem/minitest-focus#lib/minitest/focus.rb:4
