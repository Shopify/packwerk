...
module Mocha
  class << self
    # @private
    #
    # pkg:gem/mocha#lib/mocha/configuration.rb:24
    ...
    #   end
    #
    # pkg:gem/mocha#lib/mocha/configuration.rb:19
    def configure; end
  end
end
...
class Mocha::Cardinality
  ...
  # pkg:gem/mocha#lib/mocha/cardinality.rb:58
  ...
  # pkg:gem/mocha#lib/mocha/cardinality.rb:75
  ...
  # pkg:gem/mocha#lib/mocha/cardinality.rb:87
  def count(number); end

  # pkg:gem/mocha#lib/mocha/cardinality.rb:102
  def infinite?(number); end

  # pkg:gem/mocha#lib/mocha/cardinality.rb:85
  def maximum; end

  # pkg:gem/mocha#lib/mocha/cardinality.rb:85
  def required; end

  # pkg:gem/mocha#lib/mocha/cardinality.rb:96
...
#   end
#
# pkg:gem/mocha#lib/mocha/configuration.rb:39
class Mocha::Configuration
  # @private
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:55
  ...
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:244
  def display_matching_invocations_on_failure=(value); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:249
  def display_matching_invocations_on_failure?; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:65
  def merge(other); end
  ...
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:290
  def strict_keyword_argument_matching=(value); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:296
  def strict_keyword_argument_matching?; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:215
  ...
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:210
  def stubbing_method_on_nil=(value); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:127
  ...
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:122
  def stubbing_method_on_non_mock_object=(value); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:94
  ...
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:89
  def stubbing_method_unnecessarily=(value); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:160
  ...
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:155
  def stubbing_non_existent_method=(value); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:194
  ...
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:189
  def stubbing_non_public_method=(value); end

  protected

  # pkg:gem/mocha#lib/mocha/configuration.rb:51
  def options; end
  ...
  # @private
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:60
  def initialize_copy(other); end

  class << self
    # @private
    #
    # pkg:gem/mocha#lib/mocha/configuration.rb:327
    def configuration; end
    ...
    #   end
    #
    # pkg:gem/mocha#lib/mocha/configuration.rb:318
    def override(temporary_options); end

    # @private
    #
    # pkg:gem/mocha#lib/mocha/configuration.rb:302
    ...
    # @private
    #
    # pkg:gem/mocha#lib/mocha/configuration.rb:343
...
# @private
#
# pkg:gem/mocha#lib/mocha/configuration.rb:41
...
class Mocha::Expectation
  ...
  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:594
  def backtrace; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:704
  def definition_location; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:631
  ...
  #   egg.expects(:eat).in_sequence(breakfast)
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:588
  def in_sequence(sequence, *sequences); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:680
  def inspect; end
  ...
  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:646
  def match?(invocation, ignoring_order: T.unsafe(nil)); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:641
  def matches_method?(method_name); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:697
  def method_signature; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:687
  def mocha_inspect; end
  ...
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:375
  ...
  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:636
  def ordering_constraints_not_allowing_invocation_now; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:626
  ...
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:462
  ...
  #   y # => 2
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:422
  ...
  #   radio.expects(:switch_off).then(power.is('off'))
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:536
  ...
  #   object.expected_method # => 3
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:501
  ...
  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:675
  def used?; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:669
  ...
  #   radio.expects(:switch_off).then(power.is('off'))
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:560
  ...
  #   # => verify fails
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:269
  ...
  #   # => verify fails
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:289
  ...
  #   # => verify fails
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:308
  ...
  #   sum # => 2
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:347
...
class Mocha::ExpectationList
  ...
  # pkg:gem/mocha#lib/mocha/expectation_list.rb:58
...
#
# pkg:gem/mocha#lib/mocha/mock.rb:75
class Mocha::Mock
  # @private
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:275
  ...
  # pkg:gem/mocha#lib/mocha/mock.rb:289
  def __expects__(method_name_or_hash, backtrace = T.unsafe(nil)); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:346
  ...
  # @private
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:341
  def __verified__?(assertion_counter = T.unsafe(nil)); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:309
  def all_expectations; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:366
  def any_expectations?; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:361
  def ensure_method_not_already_defined(method_name); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:287
  ...
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:237
  ...
  #   sheep.foo # => raises NoMethodError exception
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:270
  def responds_like_instance_of(responder_class); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:304
  ...
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:149
  ...
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:182
  def unstub(*method_names); end

  private

  # pkg:gem/mocha#lib/mocha/mock.rb:393
  def check_expiry; end

  # pkg:gem/mocha#lib/mocha/mock.rb:387
  def check_responder_responds_to(symbol); end

  # pkg:gem/mocha#lib/mocha/mock.rb:372
  def raise_unexpected_invocation_error(invocation, matching_expectation); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:332
...
class Mocha::ParametersMatcher
  ...
  # pkg:gem/mocha#lib/mocha/parameters_matcher.rb:30
  def matchers; end
