...
class PrettyPrint
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:227
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:158
  ...
  # specify this when +sep+ is a multibyte character, for example.
  #
  # pkg:gem/prettyprint#prettyprint.rb:215
  def fill_breakable(sep = T.unsafe(nil), width = T.unsafe(nil)); end

  # outputs buffered data.
  #
  # pkg:gem/prettyprint#prettyprint.rb:291
  def flush; end
  ...
  #   lambda {|n| ' ' * n}
  #
  # pkg:gem/prettyprint#prettyprint.rb:121
  def genspace; end
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:252
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:127
  def group_queue; end

  # Takes a block and queues a new group that is indented 1 level further.
  #
  # pkg:gem/prettyprint#prettyprint.rb:263
  def group_sub; end

  # The number of spaces to be indented
  #
  # pkg:gem/prettyprint#prettyprint.rb:124
  def indent; end
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:109
  def maxwidth; end

  # Increases left margin after newline with +indent+ for line breaks added in
  # the block.
  #
  # pkg:gem/prettyprint#prettyprint.rb:280
  def nest(indent); end
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:114
  def newline; end
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:104
  def output; end
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:183
  ...
  class << self
    ...
    #   end
    #
    # pkg:gem/prettyprint#prettyprint.rb:48
    ...
    #
    # pkg:gem/prettyprint#prettyprint.rb:62
...
class PrettyPrint::Breakable
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:348
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:368
  def indent; end
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:360
  def obj; end
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:374
  def output(out, output_width); end

  # The width of +obj+ / +sep+
  #
  # pkg:gem/prettyprint#prettyprint.rb:363
  def width; end
end
...
class PrettyPrint::Group
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:402
  def initialize(depth); end

  # Makes a break for this Group, and returns true
  #
  # pkg:gem/prettyprint#prettyprint.rb:415
  def break; end

  # Boolean of whether this Group has made a break
  #
  # pkg:gem/prettyprint#prettyprint.rb:420
  def break?; end

  # Array to hold the Breakable objects for this Group
  #
  # pkg:gem/prettyprint#prettyprint.rb:412
  def breakables; end

  # This group's relation to previous groups
  #
  # pkg:gem/prettyprint#prettyprint.rb:409
  def depth; end
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:427
  def first?; end
end
...
class PrettyPrint::GroupQueue
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:448
  def initialize(*groups); end

  # Remote +group+ from this queue
  #
  # pkg:gem/prettyprint#prettyprint.rb:480
  def delete(group); end

  # Returns the outer group of the queue
  #
  # pkg:gem/prettyprint#prettyprint.rb:464
  def deq; end
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:457
  def enq(group); end
end
...
class PrettyPrint::SingleLine
  ...
  #               This argument is a noop.
  #
  # pkg:gem/prettyprint#prettyprint.rb:506
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:521
  def breakable(sep = T.unsafe(nil), width = T.unsafe(nil)); end

  # This is used as a predicate, and ought to be called first.
  #
  # pkg:gem/prettyprint#prettyprint.rb:553
  def first?; end

  # Method present for compatibility, but is a noop
  #
  # pkg:gem/prettyprint#prettyprint.rb:549
  def flush; end
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:540
  def group(indent = T.unsafe(nil), open_obj = T.unsafe(nil), close_obj = T.unsafe(nil), open_width = T.unsafe(nil), close_width = T.unsafe(nil)); end
  ...
  # Yields to a block.
  #
  # pkg:gem/prettyprint#prettyprint.rb:528
  def nest(indent); end
  ...
  # +width+ argument is here for compatibility. It is a noop argument.
  #
  # pkg:gem/prettyprint#prettyprint.rb:514
  def text(obj, width = T.unsafe(nil)); end
end
...
class PrettyPrint::Text
  ...
  # Output the text to +out+, and increment the width to +output_width+
  #
  # pkg:gem/prettyprint#prettyprint.rb:324
  def output(out, output_width); end

  # The total width of the objects included in this Text object.
  #
  # pkg:gem/prettyprint#prettyprint.rb:319
  def width; end
end

# The version string
#
# pkg:gem/prettyprint#prettyprint.rb:37
